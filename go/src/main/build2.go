...
func buildjson(r *http.Request) (result string) {
        resultmap["jsondir"]="static/result/"+time.Now().Format("20060102150405")+"/"
        resultmap["outputdir"]=resultmap["jsondir"]+"output"
        resultmap["scriptdir"]=resultmap["jsondir"]+"script"
